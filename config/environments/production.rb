Rails.application.configure do
  ...
  config.active_job.queue_name_prefix = "nanoservice_production"
  ...
  config.action_mailer.asset_host = URI::HTTPS.build(host: Rails.application.credentials.dig(Rails.env.to_sym, :domain_name)).to_s
