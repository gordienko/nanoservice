...
ActiveRecord::Schema.define(version: 2020_10_07_172153) do
  ...
  create_table "dispatches", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["message_id", "phone", "messenger_type"], name: "index_dispatches_on_message_id_and_phone_and_messenger_type", unique: true
